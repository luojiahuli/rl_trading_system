...
| **MultiStrategyAgent** | 多策略回测 + 市场状态匹配 | 10 种策略组合+单股并行回测, KMeans 聚类 |
...
- **单股级**: 每个股票独立回测 4 种基础策略，用于策略绩效对比和市场状态匹配
- **组合级**: 使用 `PortfolioBacktestEngine` 在全部股票上运行增强策略 + MTF 版本，总资金 ¥1M，最多 5 只持仓，含 5% 止损/15% 止盈

五种增强策略（含 MTF 周线过滤版本，共 10 个策略并行回测）：

| 策略 | 买入逻辑 | 卖出逻辑 |
|------|---------|---------|
| enhanced_trend | MA5>MA20 + 量比>1.2 | 收盘价跌破 MA20 |
| enhanced_momentum | 5日涨>4% + 量比>1.2 + RSI>50 | 5日涨<-3% |
| enhanced_breakout | 价格>Boll上轨 + 量比>1.5 + MACD柱>0 | 收盘价跌破 MA20 |
| enhanced_mean_reversion | RSI<28 + 价格<Boll下轨 + 量比<0.8 | RSI>55 或 价格>MA20 |
| composite | 以上 4 策略加权投票，阈值 0.25 | 加权投票 <-0.25 |
...
|------|---------|---------|------|-----------|-----------|---------|
| enhanced_trend | +43.47% | **+49.47%** | +6.00% | 1.544 | **1.791** | 190 → 49 |
| enhanced_breakout | +22.14% | **+25.99%** | +3.85% | 1.099 | **1.186** | 78 → 42 |
| enhanced_momentum | +26.73% | **+34.90%** | +8.17% | 1.128 | **1.651** | 118 → 47 |
| composite | +2.58% | **+47.21%** | **+44.63%** | 0.192 | **1.790** | 510 → 59 |
| enhanced_mean_reversion | -3.02% | -1.72% | +1.30% | -0.077 | 0.015 | 71 → 24 |

> 🏆 **最大改进**: composite (+44.63%), enhanced_momentum (+8.17%), enhanced_trend (+6.00%)
>
...
> 上图 = 基线增强策略，下图 = MTF 周线过滤版本。所有曲线平滑，无异常暴跌（修复了止损后同日加仓的仓位放大 bug）。
...
|------|---------|---------|-----------|-----------|------------|
| enhanced_trend | +43.47% | **+49.47%** | 1.544 | **1.791** | 190 → 49 |
| enhanced_breakout | +22.14% | **+25.99%** | 1.099 | **1.186** | 78 → 42 |
| enhanced_momentum | +26.73% | **+34.90%** | 1.128 | **1.651** | 118 → 47 |
| composite | +2.58% | **+47.21%** | 0.192 | **1.790** | 510 → 59 |
...
📜 **[完整交易日志](output/trading_memory.md)** — 实时交易记录

📊 **[最新每日报告](output/reports/daily_report_20260606.html)** — 2026-06-06 完整分析报告（含组合回测收益曲线）

### 最新交易摘录

| 日期 | 股票 | 操作 | 置信度 | 收益 | 持有 |
|------|------|------|--------|------|------|
| 2026-06-05 | 688111 | buy | 100% | — | — |
| 2026-06-05 | 300502 | buy | 100% | — | — |
| 2026-06-05 | 688981 | buy | 100% | — | — |
| 2026-06-05 | 300661 | buy | 100% | — | — |
| 2026-06-05 | 300750 | buy | 100% | — | — |
| 2026-06-05 | 688568 | buy | 100% | — | — |
| 2026-06-05 | 002371 | buy | 60% | — | — |
| 2026-06-05 | 603501 | buy | 60% | — | — |
| 2026-06-05 | 600703 | buy | 60% | — | — |
| 2026-06-05 | 600862 | buy | 60% | — | — |
...
- [x] RL 启发式评分决策
- [x] 10 策略回测（5 增强 × MTF 组合级 + 4 基础单股级）
